...
public class Student {
    ...
    public static Student authenticate(String id, String pass) {
        ...
        for (File schoolYearFolder : base.listFiles()) {
            if (!schoolYearFolder.isDirectory())
                continue;

            for (File yearFolder : schoolYearFolder.listFiles()) {
                ...
                for (File collegeFolder : yearFolder.listFiles()) {
                    ...
                    for (File programFolder : collegeFolder.listFiles()) {
                        ...
                        for (File sectionFolder : programFolder.listFiles()) {
                            ...
                            for (File studentFolder : sectionFolder.listFiles()) {
                                if (!studentFolder.isDirectory())
                                    continue;

                                File studentFile = new File(studentFolder, studentFolder.getName() + "_info.txt");
    ...
    public static Student findById(String studentId) {
        ...
        for (File schoolYearFolder : base.listFiles()) {
            ...
            for (File yearLevelFolder : schoolYearFolder.listFiles()) {
                if (!yearLevelFolder.isDirectory())
                    continue;

                for (File collegeFolder : yearLevelFolder.listFiles()) {
                    if (!collegeFolder.isDirectory())
                        continue;
                    ...
                    for (File programFolder : collegeFolder.listFiles()) {
                        ...
                        for (File sectionFolder : programFolder.listFiles()) {
                            ...
                            File studentFolder = new File(sectionFolder, studentId);
    ...
    private void showSchedule() {
        ...
        System.out.println("\n--- SCHEDULE ---");
        for (String x : enc)
            System.out.println(Utils.decrypt(x)); 
    }
